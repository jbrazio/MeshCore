...
/// Upto 8 bits of initial magic bit sequence can be included. Bit count can be specified with
...
/// Default Horizontal codes. When composition of text is know beforehand, the other hcodes in this section
...
/// Default preset parameter set. When composition of text is know beforehand, the other parameter sets in
/// this section can be used to achieve more compression.
...
#define USX_PSET_ALPHA_NUM_ONLY                                                             \
  USX_HCODES_ALPHA_NUM_ONLY, USX_HCODE_LENS_ALPHA_NUM_ONLY, USX_FREQ_SEQ_TXT, USX_TEMPLATES
...
#define USX_PSET_FAVOR_ALPHA                                                          \
  USX_HCODES_FAVOR_ALPHA, USX_HCODE_LENS_FAVOR_ALPHA, USX_FREQ_SEQ_TXT, USX_TEMPLATES
...
#define USX_PSET_FAVOR_UMLAUT                                                            \
  USX_HCODES_FAVOR_UMLAUT, USX_HCODE_LENS_FAVOR_UMLAUT, USX_FREQ_SEQ_DFLT, USX_TEMPLATES
